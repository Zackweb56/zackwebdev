...
const translations = {
  en: {
    ...
    'projects.project15.title': 'Project 15',
    'projects.project15.description': 'Automated Warehouse Storage Solutions.',
    'projects.project15.longDescription': 'Specializing in high-density pallet shuttle systems, this website offers efficient and automated solutions for optimizing warehouse storage, improving throughput, and managing inventory.',
  ...
  fr: {
    ...
    'projects.project15.title': 'Project 15',
    'projects.project15.description': 'Solutions de Stockage d\'Entrepôt Automatisées.',
    'projects.project15.longDescription': 'Spécialisé dans les systèmes de navettes à palettes à haute densité, ce site web propose des solutions efficaces et automatisées pour optimiser le stockage en entrepôt, améliorer le rendement et gérer les stocks.',
  ...
  ar: {
    ...
    'projects.project15.title': 'المشروع 15',
    'projects.project15.description': 'حلول تخزين المستودعات الآلية.',
    'projects.project15.longDescription': 'متخصص في أنظمة نقل البليت عالية الكثافة، يقدم هذا الموقع حلولاً فعالة وآلية لتحسين تخزين المستودعات، وتحسين الإنتاجية، وإدارة المخزون.',
