...
const Footer = () => {
  ...
  return (
    <footer className="section-padding bg-black/50 border-t border-white/10">
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <p className="text-white/60 text-center md:text-left">
              © 2024 Ahmed Benali. {t('footer.rights')}
            </p>
            ...
            <p className="text-white/60 text-center md:text-right">
              {t('footer.made')} <span className="text-red-400">❤️</span>
            </p>
          </div>
        </div>
      </div>
